...
| <a id="coco_repositories-kwargs"></a>kwargs |  Additional arguments including: - 'c' (bool): Enable C support - 'cc' (bool): Enable C++ support - 'license_source' (str): Optional license source mode - 'license_token' (str): Optional license token   |  none |
